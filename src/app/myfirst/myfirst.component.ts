...
export class MyfirstComponent implements OnInit, OnChanges{//implements es heredar de una interfaz alguna funcionalidad, en este caso estamos jalando OnInit, onchanges,
  ...
  ngOnInit(){ //Se debe de instanciar y aqui dentro esta el codigo q se ejecuta una vez que se inicio el componente. Obvio despues del codigo del constructor, porque ya dijimos que el codigo del constructor se ejecuta al inicio de todo. OJO onINIT solo se ejecuta una vez al cargar el componente.
    console.log("onInit");
